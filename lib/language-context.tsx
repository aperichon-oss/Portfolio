...
const translations: Record<Language, Record<string, string>> = {
  fr: {
    ...
    "about.profileText": "Avec 5 annees d'experience dans le commerce et un parcours en marketing digital, je me specialise aujourd'hui dans la data et l'IA appliquee au business. J'aime transformer l'analyse en decisions concretes, avec une approche a la fois technique, strategique et orientee impact.",
  ...
  en: {
    ...
    "about.profileText": "With 5 years of experience in retail and a background in digital marketing, I now specialize in data and AI applied to business. I enjoy turning analysis into concrete decisions, combining technical skills, strategic thinking and an impact-driven mindset.",
