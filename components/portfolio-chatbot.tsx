    ...
    () =>
      language === "fr"
        ? {
            ...
            projects: "Les projets sont classes par pertinence : Supply Brain - Hackathon Mirakl, Synapse - Chatbot RAG, Eugenia School - SEO/GEO, ZigZag - Mini-Jeu, puis Mario Kart - Web Scraping.",
            ...
            aboutExperience: "Son experience recente couvre le developpement de solutions IA/data pour les equipes Digital & IT chez Air Liquide, le marketing digital chez Olover, puis le management operationnel chez Carrefour City. Le fil rouge est l'articulation entre besoins business, outils digitaux, data et execution terrain.",
        ...
        : {
            ...
            projects: "Projects are ordered by relevance: Supply Brain - Mirakl Hackathon, Synapse - RAG Chatbot, Eugenia School - SEO/GEO, ZigZag - Mini-Game, then Mario Kart - Web Scraping.",
            ...
            aboutExperience: "Her recent experience includes developing AI/data solutions for Digital & IT teams at Air Liquide, digital marketing at Olover, and operational management at Carrefour City. The common thread is connecting business needs, digital tools, data and execution.",
