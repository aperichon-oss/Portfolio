...
const translations: Record<Language, Record<string, string>> = {
  fr: {
    ...
    // Project Cards
    "project.marioKart.title": "Mario Kart - Web Scraping",
    ...
    "project.zigzag.title": "ZigZag - Mini-Jeu",
