        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            ...
            <nav className="flex flex-col gap-2">
              <Link href="/supply-brain" className="text-sm text-foreground hover:text-primary transition-colors">
                {t("footer.supplyBrain")}
              </Link>
              <Link href="/synapse" className="text-sm text-foreground hover:text-primary transition-colors">
                {t("footer.synapse")}
              </Link>
              <Link href="/eugenia-school" className="text-sm text-foreground hover:text-primary transition-colors">
                {t("footer.eugenia")}
              </Link>
